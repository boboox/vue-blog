...
## ES6 Module 与 CommonJs Module的差异

- CommonJS 模块输出的是一个值的拷贝,ES6输出的是值的引用
- CommonJS 模块是运行时加载,ES6模块是编译时输出接口
- CommonJS 模块的顶层this指向当前模块,而Es6模块的顶层this指向undefined



[es6module]: http://es6.ruanyifeng.com/#docs/module  "Module 的语法"
